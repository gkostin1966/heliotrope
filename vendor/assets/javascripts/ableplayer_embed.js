...
(function ($) {
	...
	AblePlayer.prototype.setButtonImages = function() {
		...
		this.imgPath = this.rootPath + 'assets/button-icons/' + this.iconColor + '/';
...
(function ($) {
    ...
    this.$ableWrapper.addClass('able-skin-' + this.skin);
		...
		// if (this.player !== 'youtube') {
		// The player won't be visible is the max-width is set to zero when
		// embedded in Cozy Sun Bear.
		if (this.playerMaxWidth > 0) {
			...
			for (j=0; j<controls.length; j++) {
				...
				if (control === 'seek') {
					...
					if (this.iconType === 'font') {
						...
						$pipeImg = $('<img>', {
							src: this.rootPath + 'assets/button-icons/' + this.iconColor + '/pipe.png',
							alt: '',
							role: 'presentation'
						});
						$pipe.append($pipeImg);
					...
					if (control === 'volume') {
						buttonImgSrc = this.rootPath + 'assets/button-icons/' + this.iconColor + '/' + this.volumeButton + '.png';
					}
					else if (control === 'fullscreen') {
						buttonImgSrc = this.rootPath + 'assets/button-icons/' + this.iconColor + '/fullscreen-expand.png';
					}
					else if (control === 'slower') {
						if (this.speedIcons === 'animals') {
							buttonImgSrc = this.rootPath + 'assets/button-icons/' + this.iconColor + '/turtle.png';
						}
						else {
							buttonImgSrc = this.rootPath + 'assets/button-icons/' + this.iconColor + '/slower.png';
						}
					}
					else if (control === 'faster') {
						if (this.speedIcons === 'animals') {
							buttonImgSrc = this.rootPath + 'assets/button-icons/' + this.iconColor + '/rabbit.png';
						}
						else {
							buttonImgSrc = this.rootPath + 'assets/button-icons/' + this.iconColor + '/faster.png';
						}
					}
					else {
						buttonImgSrc = this.rootPath + 'assets/button-icons/' + this.iconColor + '/' + control + '.png';
					}
...
(function ($) {
	...
	AblePlayer.prototype.addWindowMenu = function(which, $window, windowName) {
		...
		if (this.iconType === 'font') {
			...
			// use image
			buttonImgSrc = this.rootPath + 'assets/button-icons/' + this.toolbarIconColor + '/preferences.png';
			$buttonImg = $('<img>',{
				'src': buttonImgSrc,
				'alt': '',
				'role': 'presentation'
...
(function ($) {
	...
	AblePlayer.prototype.getTranslationText = function() {
		...
		translationFile = this.rootPath + 'assets/translations/' + this.lang + '.js';
