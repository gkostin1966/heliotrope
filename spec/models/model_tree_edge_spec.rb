...
RSpec.describe ModelTreeEdge, type: :model do
  ...
  context 'Validation' do
    subject { described_class.new(parent_noid: parent_noid, child_noid: child_noid, kind: kind) }
    ...
    context 'valid noids' do
      ...
      context 'kinds' do
        ...
        it 'invalid' do
          expect(subject.valid?).to be false
          expect(subject.errors).to contain_exactly("Kind is not included in the list")
        end
      end
