...
module Riiif
  class File
    ...
    # Commented out because it is deprecated, Riiif Upgraded to 2.2.0
    ...
    #   block.call(tempfile)
    #   tempfile.close
    #   image = new(tempfile.path, tempfile) # rubocop:disable Lint/UselessAssignment
    # ensure
    ...
    def transformer
      if !!Riiif::Engine.config.netpdm_enabled && path.ends_with?('.tiff')
        NetpbmTransformer
