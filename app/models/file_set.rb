...
class FileSet < ActiveFedora::Base
  ...
  property :captions, predicate: ::RDF::URI.new('http://fulcrum.org/ns#captions') do |index|
    index.as :stored_searchable
  end
  ...
  property :descriptions, predicate: ::RDF::URI.new('http://fulcrum.org/ns#descriptions') do |index|
    index.as :stored_searchable
  end
